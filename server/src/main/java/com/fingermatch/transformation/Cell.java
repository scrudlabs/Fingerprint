...
public class Cell implements Iterable<Cell> {
	...
	public static final Cell[] edgeNeighbors = new Cell[] { new Cell(0, -1), new Cell(-1, 0), new Cell(1, 0),
			new Cell(0, 1) };
	public static final Cell[] cornerNeighbors = new Cell[] { new Cell(-1, -1), new Cell(0, -1), new Cell(1, -1),
			new Cell(-1, 0), new Cell(1, 0), new Cell(-1, 1), new Cell(0, 1), new Cell(1, 1) };
	public final int x;
	public final int y;
