...
public class TemplateBuilder {
	...
	public FingerprintTransparency transparency = FingerprintTransparency.none;
	public Cell size;
	...
	public static DoubleMap decodeImage(byte[] serialized) {
	...
	public static DoubleMap scaleImage(DoubleMap input, double dpi) {
